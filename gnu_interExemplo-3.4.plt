...
do for[n=0:360/dt] {
    t = n*dt
    set object 1 circle at x(t),y(t) size rand(0)*.05
    set object 2 circle at x(t+90),y(t+90) size rand(0)*.05
    set object 3 ellipse at x(t+180),y(t+180) size rand(0)*.2,rand(0)*.2
    set object 4 circle at x(t+270),y(t+270) size rand(0)*.05
    plot 1/0, 1/0
}
